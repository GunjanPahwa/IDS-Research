...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| KDD99 | kddcup.data | No | 80/20 Stratified Random Split | Ensures representative class distributions on single large file | Train: 3,918,744, Test: 979,687 | PENDING |
| NSL-KDD | KDDTrain+.txt, KDDTest+.txt | Yes (Predefined) | Use predefined splits | Official benchmarking splits | Train: 125,973, Test: 22,544 | PENDING |
| UNSW-NB15 | UNSW_NB15_training-set.csv, UNSW_NB15_testing-set.csv | Yes (Predefined) | Use predefined splits | Official benchmarking splits | Train: 175,341, Test: 82,332 | PENDING |
| CIC-IDS2017 | 8 day-wise CSV files | No | 80/20 Stratified per day-file, then combine | Preserves day-level distributions and attack representatives | Train: ~2,264,574, Test: ~566,144 | PENDING |
